...
import Development.GitRev.Utils.Environment.OsString (LookupEnvError (MkLookupEnvError))
import Development.GitRev.Utils.Environment.OsString qualified as Env
import Development.GitRev.Utils.Git.OsString (GitError (GitNotFound, GitRunError))
import Development.GitRev.Utils.Git.OsString qualified as Git
import Development.GitRev.Utils.OsString
  ( Exceptions (MkExceptions),
    GitOrLookupEnvError
      ( GitOrLookupEnvGit,
...
import Development.GitRev.Utils.OsString qualified as Utils
